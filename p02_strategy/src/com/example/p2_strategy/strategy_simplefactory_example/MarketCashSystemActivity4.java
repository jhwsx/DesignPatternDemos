package com.example.p2_strategy.strategy_simplefactory_example;//package com.example.p2_strategy.strategy_simplefactory_example;
//
...
// * @date 2018/10/2
// */
//public class MarketCashSystemActivity4 extends Activity {
//
...
//        Intent starter = new Intent(context, MarketCashSystemActivity4.class);
...
//        mAdapter = new ArrayAdapter<>(MarketCashSystemActivity4.this,
...
//                mCashContext = new CashContext(mCalculatedWay);
//            }
//
//            @Override
...
//                    Toast.makeText(MarketCashSystemActivity4.this, "单价或数量不可以为空", Toast.LENGTH_LONG).show();
//                    return;
//                }
//
